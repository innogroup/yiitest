...
class NewsCategories extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('parent_id, actived, frontpage', 'numerical', 'integerOnly'=>true),
			array('lang', 'length', 'max'=>2),
			array('title', 'length', 'max'=>128),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, lang, parent_id, title, actived, frontpage', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'category'=>array(self::BELONGS_TO, 'NewsCategories', 'parent_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('frontpage',$this->frontpage);
