...
<div id="gallery">
	...
	<a href="<?php echo Yii::app()->createUrl('news/newsContents/view',array('id'=>$model->id))?>" class="show">
		<img src="<?php echo $model->future_image; ?>" alt="Flowing Rock" width="770" height="300" title="" alt="" rel="<h3><?php echo neods($model->title,50)?></h3>"/>
	</a>
	<?php }?>
