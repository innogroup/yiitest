<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('document_no')); ?>:</b>
	<?php echo CHtml::encode($data->document_no); ?>
	<br />
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('document_path')); ?>:</b>
	<?php echo CHtml::encode($data->document_path); ?>
	<br />
